...
abstract class DynamicSearchAdapter<T : DynamicSearchAdapter.Searchable> (private val searchableList: MutableList<T>) : RecyclerView.Adapter<DynamicSearchAdapter.ViewHolder>(), Filterable {
